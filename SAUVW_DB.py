...
st.markdown(
    "We present a curated list of compounds predicted to be superconductors using our machine learning model. We make use of SuperCon [1] Database and do manual cleaning and present imporvised database named SuperCon-MTG.  "
    "The model leverages Quantum Structural Diagrams-based descriptors [2] to identify promising candidates."
)
st.divider()
